...
class AdaptiveRateLimiter:
    ...
    def __init__(self, initial_rpm: int = 60, min_rpm: int = 10, max_rpm: int = 120):
        ...
        self.limiter = RateLimiter(max_calls=initial_rpm, period=60.0)
    ...
    def _increase_rate(self):
        ...
        if new_rpm > self.current_rpm:
            ...
            self.limiter = RateLimiter(max_calls=new_rpm, period=60.0)
    ...
    def reset(self):
        ...
        with self.lock:
            ...
            self.limiter = RateLimiter(max_calls=self.initial_rpm, period=60.0)
            self.consecutive_429 = 0
            self.consecutive_success = 0
